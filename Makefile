...
ifeq ($(findstring --network sepolia,$(ARGS)),--network sepolia)
	NETWORK_ARGS := --rpc-url $(SEPOLIA_RPC_URL) --private-key $(PRIVATE_KEY) --broadcast --ffi --verify --etherscan-api-key $(ETHERSCAN_API_KEY) -vvvv
endif
...
deployMood:
	@forge script script/DeployMoodNft.s.sol:DeployMoodNft ${NETWORK_ARGS}  --no-auto-detect
